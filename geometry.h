...
public:
   ...
   ~TRI();
   void Render(RASTER *raster);
   void Render(RASTER *raster, const unsigned int *texture, unsigned int texWidth, unsigned int texHeight);
   VECTOR_3 *GetVertex(unsigned int vert);
...
public:
   ...
   void SetTexture(const unsigned int *_texture, unsigned int _width, unsigned int _height);
