...
void CAMERA::SetFOV(float degrees) { vFOV = degrees; }
...
void CAMERA::SetProjMatrix(float zNear, float zFar) {
  ...
  float projMat[4][4]{{yScale * aspectRatio, 0, 0, 0},
                      {0, yScale, 0, 0},
...
MATRIX *CAMERA::GetProjMatrix() { return projMatrix; }

void CAMERA::Invert() {
  VECTOR_3 tempVert{*(viewMatrix->GetMatrix() + 12),
                    *(viewMatrix->GetMatrix() + 13),
                    *(viewMatrix->GetMatrix() + 14)};
  float subMatrix[3][3]{
      {*(viewMatrix->GetMatrix() + 0), *(viewMatrix->GetMatrix() + 1),
       *(viewMatrix->GetMatrix() + 2)},
      {*(viewMatrix->GetMatrix() + 4), *(viewMatrix->GetMatrix() + 5),
       *(viewMatrix->GetMatrix() + 6)},
      {*(viewMatrix->GetMatrix() + 8), *(viewMatrix->GetMatrix() + 9),
       *(viewMatrix->GetMatrix() + 10)},
  };
